...
int main() {
    ...
    objl::Loader Loader;
	// Load .obj File
	bool loadout = Loader.LoadFile("/home/kenny/Documents/Projects/cuda-rt/meshes/obj/cornell.obj");
    ...
    create_world<<<1,1>>>(d_list,d_world,d_camera,14, vec_list);
    ...
    // clean up
    checkCudaErrors(cudaDeviceSynchronize());
    free_world<<<1,1>>>(d_list,d_world,d_camera,14);
    checkCudaErrors(cudaGetLastError());
